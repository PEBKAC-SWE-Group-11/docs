...
\input{contents/requirements/functionality_requirements}
\subsection{Registro di Qualità}
\input{contents/requirements/quality_requirements}
\subsection{Requisiti di Vincolo}
\input{contents/requirements/constraint_requirements}