...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{contents/casi_duso/png/UC11.2.png}
\caption{UC11.2 - Fornitura di feedback negativo sulla risposta del sistema ad inter-
rogazione}
% \label{fig:UC1a}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{contents/casi_duso/png/UC12.1.png}
\caption{UC12.1 - Inserimento username}
% \label{fig:UC1a}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{contents/casi_duso/png/UC13.png}
\caption{UC13 - Inserimento username o password errati}
% \label{fig:UC1a}
\end{figure}
